...
from dnnport.utils import errors
...
class Scheduler:
    ...
    def add_job(self, job):
        ...
        if not self.running:
            ...
            from dnnport.webapp import app, socketio
            ...
            if 'DNNPORT_MODE_TEST' not in os.environ:
    ...
    def delete_job(self, job):
        ...
        if job:
            ...
            from dnnport.webapp import socketio
            socketio.emit('job update',
                          {
                              'update': 'deleted',
                              'job_id': job.id()
    ...
    def emit_gpus_available(self):
        ...
        """
        from dnnport.webapp import scheduler, socketio
